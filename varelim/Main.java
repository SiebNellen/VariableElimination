...
//		String heuristic = ui.getHeuristic();
		...
		System.out.println();
		VariableElimination elim = new VariableElimination(factors, vs, observed, query);
		Factor result = elim.elimination();
		System.out.println("The result is:");
		System.out.println(result.getVariable());
		System.out.println(result.getValues());
		System.out.println(result.getProb());
	}
}